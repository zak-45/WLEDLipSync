(function ( w, d, PKAE ) {
						...
						action: function () {
								new PKSimpleModal({
								  ...
								  body:'<div class="pk_row"><label for="k0">File Name</label>' + 
									'<input style="min-width:250px" placeholder="mp3 filename" value="WLEDLipSync-output.mp3" ' +
	...
	function _makeUIMainView ( UI, app ) {
		...
		'onclick="PKAudioEditor.engine.LoadSample()">here to use WLEDLipSync work file</a>';
