...
class ConfigManager:
    ...
    def setup(self):
        ...
        # read config
        # create logger
        self.logger = setup_logging(self.logging_config_path, self.logger_name)

        lip_config = read_config()

        # config keys
        self.server_config = lip_config[0]  # server key
        self.app_config = lip_config[1]  # app key
        self.color_config = lip_config[2]  # colors key
        self.custom_config = lip_config[3]  # custom key
